...
public class AuthorController {
	...
	public ResponseEntity<Author> addAuthor(@RequestBody Author a) { // indicate that the author will be found in the
																		// request body
		a = authorService.addAuthor(a);
		if (a == null) {
			return new ResponseEntity<Author>(a, HttpStatus.CONFLICT); // if there is issue with adding return with
																		// status of conflict
		} else {
