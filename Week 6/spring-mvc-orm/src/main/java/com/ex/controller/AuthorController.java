...
//Takes in request and then does everything from mapping -> getting data -> binds response
//as an object using jackson binding and then renders view using that
@RestController
//Regular controller uses @responseBody 
