...
public class GarbageDriver {
	...
	public static void main(String[] args) {
		...
		try {
			Thread.sleep(5000);	// measured in milliseconds
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		obj = null;
		System.gc();	// this is just a request; this doesn't force garbage collection
		System.out.println("at end of main method");
	}
	
	// finalize() = method called by garbage collector before object
