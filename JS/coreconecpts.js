...
function scopes(cond){
    ...
    var functionlet="This is a declared function using let in a function";
    var functionconst="declarfed using const in a function";
...
if(cond){
    ...
    blockC=5
    console.log("changed the values of block c"=$(blockC))
}
