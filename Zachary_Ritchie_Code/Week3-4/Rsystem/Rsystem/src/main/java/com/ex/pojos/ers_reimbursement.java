...
public class ers_reimbursement 
{
	...
	public ers_reimbursement(int reimb_id, double reimb_amount, String reimb_submitted, String reimb_resolved,
	...
	public void setReimb_submitted(String timestamp) {
		this.reimb_submitted = timestamp;
	}
