...
function fib(userinput){

     userinput=document.getElementById("fibinput").value;
    let calc=0;
...
function reverseString(userz){

    userz=document.getElementById("reverseinput").value;
...
function factorial(userinput){
     userinput=document.getElementById("factorialinput").value;
    let calc=userinput;
...
function isEven(userinput){
     userinput=document.getElementById("eveninput").value;
...
function palindrome(userz){
     userz=document.getElementById("palindromeinput").value;
...
function makePerson(namez,agez){
     namez=document.getElementById("nameinput").value;
     agez=document.getElementById("ageinput").value;
